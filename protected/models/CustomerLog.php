...
class CustomerLog extends MyActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, create_time, update_time, create_user_id, update_user_id, organization_id, user_id', 'numerical', 'integerOnly'=>true),
			array('log_action', 'length', 'max'=>16),
			array('position, value', 'length', 'max'=>255),
			array('description', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('log_id, log_action, id, create_time, update_time, create_user_id, update_user_id, organization_id, user_id, position, value, description', 'safe', 'on'=>'search'),
		);
	}
