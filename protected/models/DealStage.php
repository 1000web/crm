...
/**
 * This is the model class for table "{{deal_stage}}".
 *
 * The followings are the available columns in table '{{deal_stage}}':
 * @property integer $id
 ...
 */
class DealStage extends MyActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return DealStage the static model class
     */
