...
class ProductLog extends LogActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('log_datetime, log_user_id, id, product_type_id', 'numerical', 'integerOnly' => true),
            array('log_action', 'length', 'max' => 16),
            array('value', 'length', 'max' => 255),
            array('description', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('log_id, log_action, log_datetime, log_user_id, id, product_type_id, value, description', 'safe', 'on' => 'search'),
        );
    }
