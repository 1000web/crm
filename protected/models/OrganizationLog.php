 ...
 */
class OrganizationLog extends MyActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('id, organization_type_id, organization_group_id, organization_region_id, value', 'required'),
            array('id, deleted, create_time, update_time, create_user_id, update_user_id, organization_type_id, organization_group_id, organization_region_id', 'numerical', 'integerOnly' => true),
            array('value', 'length', 'max' => 255),
            array('description', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('log_id, id, deleted, create_time, update_time, create_user_id, update_user_id, organization_type_id, organization_group_id, organization_region_id, value, description', 'safe', 'on' => 'search'),
        );
    }
