...
/**
 * This is the model class for table "{{task_type_log}}".
 *
 * The followings are the available columns in table '{{task_type_log}}':
 ...
 */
class TaskTypeLog extends LogActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return TaskTypeLog the static model class
     */
    ...
    public function getAll($userProfile, $id)
    {
        ...
        return new CActiveDataProvider('TaskTypeLog', array(
            'criteria' => $criteria,
            'pagination' => array(
