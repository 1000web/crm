...
/**
 * This is the model class for table "{{product_type_log}}".
 *
 * The followings are the available columns in table '{{product_type_log}}':
 ...
 */
class ProductTypeLog extends LogActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProductTypeLog the static model class
     */
