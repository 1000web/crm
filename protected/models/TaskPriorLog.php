...
/**
 * This is the model class for table "{{task_prior_log}}".
 *
 * The followings are the available columns in table '{{task_prior_log}}':
 ...
 */
class TaskPriorLog extends LogActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TaskPriorLog the static model class
	 */
