...
$attr = array(
    ...
    array('name' => 'deal_source_id', 'label' => $this->attributeLabels('deal_source_id'), 'value' => $model->deal_source->value),
    array('name' => 'deal_stage_id', 'label' => $this->attributeLabels('deal_stage_id'), 'value' => $model->deal_stage->value),
